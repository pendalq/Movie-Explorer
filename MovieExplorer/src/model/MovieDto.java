...
/*
TITLE, DIRECTOR, ACTOR_1, ACTOR_2, ACTOR_3, ACTOR_4, "
SYNOP, GOOD_POINT, GENRE_1, GENRE_2, GRADE_POINT, NOW_SCREENING
*/

public class MovieDto {
	
	String movieTitle; // ��ȭ �̸�
	String director; // ����
	String actor1; // ���
	String actor2;
	String actor3;
	...
	String synop; // �ó�ý� // ������ ���丮
	int movieGPoint; // ����
	String movieGenre1; // ��ȭ �ش� �帣
	String movieGenre2; // ��ȭ �ش� �帣
	double gradePoint;
	int screening;
	...
	public MovieDto(String movieTitle, String director, String actor1, String actor2, String actor3, String actor4,
			String synop, int movieGPoint, String movieGenre1, String movieGenre2, double gradePoint, int screening) {
		super();
